...
import { IOauth as IOauth, oauthDataSchema } from "./Oauth.model";
...
const SocialMediaAccount = mongoose.models.SocialMediaAccount || mongoose.model<IOauth>("SocialMediaAccount", oauthDataSchema);
